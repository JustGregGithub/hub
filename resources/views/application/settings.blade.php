    ...
    <div class="p-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-100 w-full">
                <div class="mt-10">
                    <h1 class="text-xl font-bold">Application Settings <span class="font-normal text-sm text-gray-500">- Modify & View Application settings</span>
                    </h1>
                </div>
                <div>
...
{{--                                                    <input type="text" name="colour_right" placeholder="Colour To" class="border border-gray-300 rounded-md text-sm w-full" value="{{ $section->colour_right }}">--}}
                ...
                <div class="bg-white rounded-xl p-4 mt-4">
                    @can('is-mgmt')
                        ...
                        <div class="flex justify-between items-center">
                            <span class="font-extrabold">Applications</span>
