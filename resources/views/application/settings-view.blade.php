    ...
    <div class="p-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-100 w-full">
                <div class="mt-10">
                    <h1 class="text-xl font-bold"><span class="font-normal text-gray-500">Application Settings</span> / {{ $category->name }}</h1>
                </div>
                <div class="bg-white rounded-xl p-4 mt-4">
                        ...
                        <div class="flex gap-4">
                            <form method="POST" action="{{ route('applications.settings.application.interview', $category->id) }}" class="mt-2">
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <label for="interviewCategory" class="block text-sm font-medium text-gray-700 w-full">Interview Ticket Category?
                    ...
                    <div class="bg-gray-50 rounded-md mt-4 p-4">
