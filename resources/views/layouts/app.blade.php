...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        @if (Session::has('success'))
            <div id="toast-success" class="fixed top-5 right-5 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-700" role="alert">
        ...
        <p hidden class="hidden text-orange-500 bg-orange-500 bg-orange-200 text-blue-500 bg-blue-500 text-green-500 bg-green-200 bg-green-500 text-red-500 bg-red-200 bg-red-500"></p>
