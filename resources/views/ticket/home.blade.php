        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mt-10">
                    <div class="flex justify-between items-center">
                        <h1 class="text-xl font-bold dark:text-gray-400">Tickets</h1>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-4">
                        <div class="bg-white dark:bg-slate-600 p-6 rounded-xl h-fit">
                            <span class="text-xl font-bold dark:text-gray-300">My Recently Created Tickets <span class="font-normal text-sm text-gray-500 dark:text-gray-400">- Showing {{ count($tickets) }} of {{ $ticketCount }} tickets</span></span>
                            @foreach($tickets as $ticket)
                                    <div class="bg-gray-50 dark:bg-slate-500 rounded-xl p-4 mt-4">
                                        <div class="flex justify-between items-center">
                        ...
                        <div class="bg-white dark:bg-slate-600 p-6 rounded-xl">
                            <h1 class="text-xl font-bold dark:text-gray-300">My Pinned Tickets <span class="font-normal text-sm text-gray-500 dark:text-gray-400">- Showing {{ $pinnedTicketCount }} tickets</span></h1>
