            ...
            <div class="bg-gray-100 w-full">
                <div class="mt-10">
                    <div class="flex justify-between">
                        <h1 class="text-xl font-bold">All Tickets <span class="font-normal text-sm text-gray-500">- Sorted by latest</span></h1>
                        ...
                        <div class="bg-white rounded-xl p-4 mt-4">
                            ...
                            <p class="text-gray-400 text-sm mt-2 text-right">Updated: {{ $ticket->updated_at->diffForHumans() }}</p>
                        </div>
                    @endforeach
