            ...
            <div class="mt-10">
                ...
                <div class="bg-white dark:bg-slate-600 rounded-xl p-4 mt-4 flex flex-col gap-4">
                    ...
                    <div class="bg-gray-100 dark:bg-slate-500 rounded-md p-4">
                        <span class="font-bold dark:text-gray-300">Assigned Tickets ({{\App\Models\Ticket::where('assigned_person', Request::user()->id, true)->where('category_id', $category->id)->get()->count()}})</span>
