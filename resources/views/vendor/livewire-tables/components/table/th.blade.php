...
@if ($theme === 'tailwind')
    <th scope="col" {{
        $attributes->merge($customAttributes)
            ->class(['px-6 py-3 text-left text-xs font-medium whitespace-nowrap uppercase tracking-wider bg-purple-400 text-gray-700' => $customAttributes['default'] ?? true])
            ...
            <button
                ...
                {{
                    $attributes->merge($customSortButtonAttributes)
                        ->class(['flex items-center space-x-1 text-left text-xs leading-4 font-medium uppercase tracking-wider group focus:outline-none text-gray-700' => $customSortButtonAttributes['default'] ?? true])
