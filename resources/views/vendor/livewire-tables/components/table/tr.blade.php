...
@if ($theme === 'tailwind')
    <tr
        wire:loading.class.delay="bg-purple-400 opacity-40"
        ...
        {{
            $attributes->merge($customAttributes)
                ->class(['bg-zinc-800 dark:text-white' => ($customAttributes['default'] ?? true) && $rowIndex % 2 === 0])
                ->class(['bg-zinc-900 dark:text-white' => ($customAttributes['default'] ?? true) && $rowIndex % 2 !== 0])
