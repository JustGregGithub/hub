<x-app-layout>
    <div class="p-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mt-10">
                <h1 class="text-xl font-bold dark:text-gray-300"><span
            ...
            <div class="bg-white dark:bg-slate-600 rounded-xl p-4 mt-4 dark:text-gray-300">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="grid grid-rows-1 md:grid-rows-2 gap-4">
                        <div class="bg-gray-50 dark:bg-slate-500 rounded-md p-4 h-fit">
                            ...
                            <livewire:select-dropdown column="application_section_id" label="Application Section"
                                                      :model="$category"/>
                            <hr class="h-px my-8 mt-4 mb-4 bg-gray-200 border-0 dark:bg-gray-700 ">

                            <div>
                                <form method="POST"
                                      action="{{ route('applications.settings.application.interview', $category->id) }}"
                                      class="mt-2">
                                    @csrf
                                    @method('PATCH')
                                    <div class="flex gap-4">
                                        <label for="interviewTicket"
                                            ...
                                            <select name="interviewTicket"
                                                ...
                                                <option value="0" @if($category->create_interview == 0) selected @endif>
                                                    No
                                                </option>
                                            </select>
                                        </label>
                                    ...
                                    <input type="submit" value="Submit Interview Changes"
                                           class="bg-green-500 hover:bg-green-400 transition rounded-md px-4 py-2 text-white w-full mt-2 cursor-pointer mt-4">
                                </form>
                            </div>
                        </div>
                        <div class="bg-gray-50 dark:bg-slate-500 rounded-md p-4 h-fit">
                            ...
                            <div class="flex gap-4 items-center">
                                <label class="flex flex-col w-1/4">
                                    <div class="flex gap-2">
                                        <div id="tooltip-role" role="tooltip"
                                        ...
                                        <svg data-tooltip-target="tooltip-role" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <livewire:toggle-component :model="$category" column="restrict"
                                                               label="Restrict Application"/>
                                </label>
                                <div class="flex flex-col w-full">
                                    <livewire:input-box :model="$category" column="restrict_guild"
                                                        label="Restrict Guild ID"/>
                                    <livewire:input-box :model="$category" column="restrict_role"
                                                        label="Restrict Role ID"/>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <label class="flex flex-col w-1/4">
                                    <div class="flex gap-2">
                                        <div id="tooltip-question" role="tooltip"
                                             class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-500 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                            Toggle whether a role should be added to the user upon application approval.
                                            <div class="tooltip-arrow" data-popper-arrow></div>
                                        </div>

                                        <span class="text-gray-700 dark:text-gray-300 mb-1">Add Role</span>
                                        <svg data-tooltip-target="tooltip-question" xmlns="http://www.w3.org/2000/svg"
                                             fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                             class="w-6 h-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                  d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 5.25h.008v.008H12v-.008z"/>
                                    ...
                                    <livewire:toggle-component :model="$category" column="add_role"
                                                               label="Enable Application"/>
                                </label>
                                <div class="flex flex-col w-full">
                                    <livewire:input-box :model="$category" column="role_guild"
                                                        label="Discord Guild ID"/>
                                    <livewire:input-box :model="$category" column="role" label="Discord Role ID"/>
                                </div>
                            </div>
                        </div>
                        <div class="bg-gray-50 dark:bg-slate-500 rounded-md p-4 h-fit">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-6 space-y-2">
                                            <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">Are
                                                you sure you want to delete the application category? This will also
                                                delete all active applications. <span
                                                        class="font-extrabold text-red-500"> This is un-recoverable! </span>
                                            </p>
                                            <form method="POST"
                                                  action="{{ route('applications.settings.application.delete', $category->id) }}">
                                                @csrf
                                                @method('DELETE')
                                                <input type="text" name="category_id" placeholder="Application Category"
                                                       class="border border-gray-300 rounded-md text-sm hidden"
                            ...
                            <div class="flex flex-col justify-center">
                                ...
                                <div class="flex gap-4 items-baseline">
                                    @can('is-mgmt')
                                        <livewire:input-box :model="$category" column="manager_role"
                            ...
                            @can('is-mgmt')
                                <button class="bg-red-500 hover:bg-red-400 transition rounded-md px-4 py-2 text-white w-full mt-2 cursor-pointer mt-4"
                ...
                <div class="bg-gray-50 dark:bg-slate-500 rounded-md mt-4 p-4">
                    ...
                    <form method="POST"
                        ...
                        <input type="submit" value="Update Category Information"
                               class="bg-green-500 hover:bg-green-400 transition rounded-md px-4 py-2 text-white w-full mt-2 cursor-pointer mt-4">
                    </form>
                    <x-tiny-mce/>
                </div>
                <div class="bg-gray-50 dark:bg-slate-500 rounded-md mt-4 p-4">
                    <div class="flex justify-between text-lg">
                        ...
                        <button href="" class="bg-green-500 hover:bg-green-700 text-white px-4 py-2 rounded-md"
                                data-modal-target="createModal" data-modal-toggle="createModal">Create
                        </button>
                    </div>
                    ...
                    <div id="createModal" tabindex="-1" aria-hidden="true"
                        ...
                        <div class="relative w-full max-w-2xl max-h-full">
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <!-- Modal body -->
                                <div class="p-6 space-y-2">
                                    <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">Please enter
                                        the question and position you would like to add to the <span
                                                class="font-extrabold text-black">{{ $category->name }}</span>
                                        application</p>
                                    <form method="POST"
                                          action="{{ route('applications.settings.question.create', $category->id) }}">
                                        @csrf
                                        <div class="flex gap-2">
                    ...
                    <div class="mt-4">
                        <div class="flex flex-col">
                            ...
                            @foreach ($sortedQuestions as $question)
                                {{-- Move Modal --}}
                                <div id="moveModal-{{ $question->id }}" tabindex="-1" aria-hidden="true"
                                     class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative w-full max-w-2xl max-h-full">
                                        <!-- Modal content -->
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-6 space-y-2">
                                                <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                                                    Please enter the new position this question.</p>
                                                <form method="POST"
                                                      action="{{ route('applications.settings.question.move', $category->id) }}">
                                                    @csrf
                                                    @method('PATCH')
                                                    <input type="text" name="question_id" placeholder="Question"
                                                           class="border border-gray-300 rounded-md text-sm hidden"
                                                           value="{{ $question->id }}" hidden>
                                                    <input type="text" name="position" placeholder="Position"
                                                           class="border border-gray-300 rounded-md text-sm w-full dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                    <input type="submit" value="Move Question"
                                                           class="bg-green-500 hover:bg-green-400 transition rounded-md px-4 py-2 text-white w-full mt-2 cursor-pointer">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div id="renameModal-{{ $question->id }}" tabindex="-1" aria-hidden="true"
                                     class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative w-full max-w-2xl max-h-full">
                                        <!-- Modal content -->
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-6 space-y-2">
                                                <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                                                    Please enter the new position for this question.</p>
                                                <form method="POST"
                                                      action="{{ route('applications.settings.question.rename', $category->id) }}">
                                                    @csrf
                                                    @method('PATCH')
                                                    <input type="text" name="question_id" placeholder="Question"
                                                           class="border border-gray-300 rounded-md text-sm hidden"
                                                           value="{{ $question->id }}" hidden>
                                                    <input type="text" name="question" placeholder="Question Name"
                                                           class="border border-gray-300 rounded-md text-sm w-full dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                    <input type="submit" value="Rename Question"
                                                           class="bg-green-500 hover:bg-green-400 transition rounded-md px-4 py-2 text-white w-full mt-2 cursor-pointer">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div id="typeModal-{{ $question->id }}" tabindex="-1" aria-hidden="true"
                                     class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative w-full max-w-2xl max-h-full">
                                        <!-- Modal content -->
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-6 space-y-2">
                                                <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                                                    Please select the type of the question and fill in any necessary
                                                    information. If you'd like to change the pre-existing inputs (e.g
                                                    existing select), you will need to input the same information in the
                                                    respective order with the changes.</p>
                                                <form method="POST"
                                                      action="{{ route('applications.settings.question.type', $category->id) }}">
                                                    @csrf
                                                    @method('PATCH')
                                                    <input type="text" name="question_id" placeholder="Question"
                                                           class="border border-gray-300 rounded-md text-sm hidden"
                                                           value="{{ $question->id }}" hidden>
                                                    <select name="type" id="type-{{ $question->id }}"
                                                            class="border border-gray-300 rounded-md text-sm mt-2 w-full dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                        @foreach(\App\Models\Hub\ApplicationQuestion::OPTION_TYPES as $key=>$value)
                                                            <option value="{{ $value }}"
                                                                    @if($question->type == $value) selected @endif>{{ $key }}</option>
                                                        @endforeach
                                                    </select>

                                                    <div id="options-{{ $question->id }}"
                                                         @if(!in_array($question->type, [\App\Models\Hub\ApplicationQuestion::OPTION_TYPES['Select'], \App\Models\Hub\ApplicationQuestion::OPTION_TYPES['Radio']])) class="hidden"
                                                         @else class="block" @endif >
                                                        <div id="inputContainer-{{ $question->id }}"></div>
                                                        <div id="buttons-{{ $question->id }}">
                                                            <button type="button"
                                                                    onclick="addInputField_{{$question->id}}()"
                                                                    class="bg-green-500 hover:bg-green-400 transition px-4 py-2 rounded-md">
                                                                Add Input
                                                            </button>
                                                            <button type="button"
                                                                    onclick="removeInputField_{{$question->id}}()"
                                                                    class="bg-red-500 hover:bg-red-400 transition px-4 py-2 rounded-md">
                                                                Remove Input
                                                            </button>
                                                    ...
                                                    <input type="submit" value="Set Question Type"
                                                           class="bg-green-500 hover:bg-green-400 transition rounded-md px-4 py-2 text-white w-full mt-2 cursor-pointer">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div id="deleteModal-{{ $question->id }}" tabindex="-1" aria-hidden="true"
                                     class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative w-full max-w-2xl max-h-full">
                                        <!-- Modal content -->
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-6 space-y-2">
                                                <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                                                    Are you sure you want to delete the question? <span
                                                            class="font-extrabold text-red-500"> This is un-recoverable! </span>
                                                </p>
                                                <form method="POST"
                                                      action="{{ route('applications.settings.question.delete', $category->id) }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <input type="text" name="question_id" placeholder="Question"
                                                           class="border border-gray-300 rounded-md text-sm hidden"
                                ...
                                <div class="flex flex-row justify-between items-center">
                                    ...
                                    <button data-dropdown-toggle="dropdown-{{ $question->id }}"
    ...
    <script>
        ...
        document.getElementById('type-{{$question->id}}').addEventListener('change', function () {
            ...
            if (value === {{ \App\Models\Hub\ApplicationQuestion::OPTION_TYPES['Select'] }} || value === {{ \App\Models\Hub\ApplicationQuestion::OPTION_TYPES['Radio'] }}) {
