...
class TicketsController extends Controller
{
    ...
    public function all(Request $request) {
        ...
        $tickets = $request->user()->tickets()->orderByDesc('updated_at')->paginate(10);

        if ($tickets->count() == 0) abort(404);

        return view('hub.ticket.all', [
            'tickets' => $tickets,
    ...
    public function settings() {
        ...
        return view('hub.ticket.settings', [
